...
public class PickaxeWeaknessAbility implements VisibleAbility, Listener {
    ...
    private static final double DAMAGE_MULTIPLIER = 1.5; // Take 50% more damage
    ...
    public void onDamage(EntityDamageByEntityEvent event) {
        ...
        if (!(event.getDamager() instanceof Player damager)) return; // Only consider player attackers for simplicity
