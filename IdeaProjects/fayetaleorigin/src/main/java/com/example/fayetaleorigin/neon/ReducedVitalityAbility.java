...
import com.starshootercity.version.MVAttribute; // <-- Import MVAttribute
...
// Removed com.starshootercity.OriginsReborn import if no longer needed
...
public class ReducedVitalityAbility implements VisibleAbility, AttributeModifierAbility {
    ...
    public @NotNull Attribute getAttribute() {
        // Use MVAttribute to get the Max Health attribute
        Attribute maxHealthAttribute = MVAttribute.MAX_HEALTH.get();
        if (maxHealthAttribute == null) {
            // If MVAttribute.MAX_HEALTH.get() returns null, it's a critical issue with the
            // Origins Reborn version wrapper or setup. Throw an error to make it obvious.
