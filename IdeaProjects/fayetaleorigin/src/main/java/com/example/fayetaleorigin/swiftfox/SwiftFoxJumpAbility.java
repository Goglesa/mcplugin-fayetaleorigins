...
import com.starshootercity.version.MVAttribute; // Using MVAttribute for compatibility
...
public class SwiftFoxJumpAbility implements VisibleAbility, AttributeModifierAbility {
    ...
    // Value to add to jump strength. Default is ~0.42.
    // Adding 0.15 to 0.2 should result in ~2 block jump. Needs testing.
